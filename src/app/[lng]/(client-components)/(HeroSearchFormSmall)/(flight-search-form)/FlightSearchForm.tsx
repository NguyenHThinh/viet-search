    ...
    return (
      <div className="">
        <Popover className="relative">
          {({ open }) => (
            <>
              <Popover.Button className="inline-flex items-center rounded-md px-4 py-1.5 text-xs font-medium hover:text-opacity-100 focus:outline-none focus-visible:ring-0">
              ...
              >
                <Popover.Panel className="absolute left-1/2 top-full z-20 mt-3 w-full max-w-sm -translate-x-1/2 rounded-3xl bg-white px-4  py-5 shadow-xl ring-1 ring-black/5 dark:bg-neutral-800 dark:ring-white/10 sm:min-w-[340px] sm:px-8 sm:py-6">
                  <NcInputNumber
                    className="w-full"
          ...
          {({ open, close }) => (
            <>
              ...
              <Transition
                ...
                leaveTo="opacity-0 translate-y-1"
              >
                <Popover.Panel className="absolute left-1/2 z-30 mt-3 w-screen max-w-[200px] -translate-x-1/2 px-4 sm:max-w-[220px] sm:px-0">
