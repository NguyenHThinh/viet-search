        ...
        <div className="mt-2">
          {[
            ...
            <span
              ...
              key={item}
              className="flex cursor-pointer items-center space-x-3 p-4 hover:bg-neutral-100 dark:hover:bg-neutral-700 sm:px-6"
            >
  ...
  return (
    <div className={`relative flex ${className}`} ref={containerRef}>
      <div
        ...
        className={`[ nc-hero-field-padding--small ] relative z-10 flex flex-1 shrink-0 cursor-pointer items-center space-x-3 text-left focus:outline-none ${
          showPopover ? "nc-hero-field-focused--2" : ""
        }`}
      >
        <div className="flex-1">
          <input
            className="block w-full truncate border-none bg-transparent p-0 font-semibold placeholder:text-neutral-800 focus:outline-none focus:ring-0 focus:placeholder:text-neutral-400 dark:placeholder:text-neutral-200 xl:text-base"
