...
export default function VietSearchForBusinessDropdown() {
  ...
  const solutions: SolutionItem[] = [
    ...
    },
    {
      ...
      description: t("common:claimYourBusinessSubTitle"),
      href: PATH_CLAIM.searchClaim,
      icon: IconOne,
    },
    // {
  ...
  return (
    <div
      className="VietSearchForBusinessDropdown relative flex"
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      <>
        <div
          className={`${isHovered ? "" : "text-opacity-90"}
        ...
        >
          <div className={` inline-flex items-center `} role="button">
            ...
            <ChevronDownIcon
              className={`${isHovered ? "-rotate-180" : "text-opacity-70 "}
        ...
        {isHovered && (
          ...
          >
            <div className="absolute left-1/2 top-full z-40 w-screen max-w-xs -translate-x-1/2 px-4 sm:px-0">
              <div className="overflow-hidden rounded-2xl shadow-lg ring-1 ring-black ring-opacity-5">
                <div className="relative grid grid-cols-1 gap-7 bg-white p-7 dark:bg-neutral-800 ">
                  {solutions.map((item, index) => (
                    <Link
                      ...
                      onClick={() => close()}
                      className={`-m-3 flex items-center rounded-lg p-2 transition duration-150 ease-in-out hover:bg-neutral-50 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50 dark:hover:bg-neutral-700 ${item.active ? "bg-neutral-100 dark:bg-neutral-700" : ""}`}
                    >
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-primary-50 text-primary-500 sm:h-12 sm:w-12">
                ...
                <div className="bg-neutral-50 p-4 dark:bg-neutral-700">
                  <Link
                    href={PATH_PAGE.business.root}
                    className="flow-root space-y-0.5 rounded-md p-2 transition duration-150 ease-in-out focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
                  >
                    ...
                    <span className="block text-sm text-gray-500 dark:text-neutral-400">
                      {t("common:learnAboutBusinessVietSearch")}
                    </span>
                  </Link>
                </div>
              </div>
