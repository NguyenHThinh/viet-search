...
const Header3: FC<Header3Props> = ({ className = "", lng }) => {
  ...
  const renderButtonOpenHeroSearch = () => {
    return (
      ...
      >
        ...
        <div
          className="ml-auto shrink-0 cursor-pointer pr-2"
          onClick={() => setShowHeroSearch("location")}
        >
  ...
  return (
    <>
      <div
        className={`nc-Header nc-Header-3 fixed inset-0 z-40 bg-black/30 transition-opacity will-change-[opacity] dark:bg-black/50 
        ${
