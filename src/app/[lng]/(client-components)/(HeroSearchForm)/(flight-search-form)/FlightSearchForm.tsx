          ...
          <>
           ...
           ${open ? "" : ""}
            ...
            <Transition
              ...
              leaveTo="opacity-0 translate-y-1"
            >
              <Popover.Panel className="absolute left-1/2 top-full z-20 mt-3 w-screen max-w-[200px] -translate-x-1/2 px-4 sm:max-w-[220px] sm:px-0">
  ...
  const renderRadioBtn = () => {
    return (
      <div className=" [ nc-hero-field-padding ] flex flex-row flex-wrap border-b border-neutral-100 py-5 dark:border-neutral-700">
        ...
        <div className="my-1 mr-2 h-8 self-center border-r border-slate-200 dark:border-slate-700 sm:mr-3" />
